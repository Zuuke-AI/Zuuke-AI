...
function AuthForm() {
  ...
  const switchMode = (m: 'signup' | 'login' | 'forgot') => {
    setMode(m)
    setAlert(null)
    setErrors({})
    setAvailStatus('idle')
            ...
            <div>
              ...
              <div className="form-group">
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 }}>
                  ...
                  <a href="#" className="forgot-link" style={{ float: 'none', marginBottom: 0 }} onClick={(e) => { e.preventDefault(); switchMode('forgot') }}>Forgot password?</a>
                </div>
                <div className="input-wrap">
                  <input
